...
TEST_F(DingoSerialTest, boolSchema) {
  ...
  string* bs1 = new string();
  Buf* bf1 = new Buf(*bs1, this->le);
  ...
  b3.SetIsKey(true);
  string* bs4 = new string();
  Buf* bf7 = new Buf(*bs4, this->le);
