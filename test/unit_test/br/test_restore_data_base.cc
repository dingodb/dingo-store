...
class BrRestoreDataBaseTest;

static void TestRestoreData(const BrRestoreDataBaseTest& restore_data,
...
class BrRestoreDataBaseTest : public testing::Test {
 protected:
  ...
  friend void TestRestoreData(const BrRestoreDataBaseTest& restore_data,
                              std::shared_ptr<dingodb::pb::common::BackupMeta> store_region_data_sst,
                              std::shared_ptr<dingodb::pb::common::BackupMeta> store_cf_sst_meta_data_sst,
                              std::shared_ptr<dingodb::pb::common::BackupMeta> index_region_data_sst,
                              std::shared_ptr<dingodb::pb::common::BackupMeta> index_cf_sst_meta_data_sst,
...
static void TestRestoreData(const BrRestoreDataBaseTest& restore_data,
                            ...
                            std::shared_ptr<dingodb::pb::common::BackupMeta> document_cf_sst_meta_data_sst,
                            const std::string& type_name) {
  std::shared_ptr<br::RestoreDataBase> restore_region_data_manager = std::make_shared<br::RestoreDataBase>(
      ...
      restore_data.create_region_timeout_s, restore_data.restore_region_timeout_s, restore_data.replica_num, type_name);
...
TEST_F(BrRestoreDataBaseTest, Init) {
...
TEST_F(BrRestoreDataBaseTest, RestoreSqlData) {
...
TEST_F(BrRestoreDataBaseTest, RestoreSdkData) {
  const std::string backupmeta_datafile_file_path = base_dir + "backupmeta.datafile";
