...
#        INSTALL_COMMAND mkdir -p ${OPENBLAS_INSTALL_DIR}/lib/ COMMAND cp ${OPENBLAS_BINARY_DIR}/lib/libopenblas.a ${OPENBLAS_LIBRARIES} COMMAND cp -r ${OPENBLAS_BINARY_DIR}/include ${OPENBLAS_INCLUDE_DIR}/
)
