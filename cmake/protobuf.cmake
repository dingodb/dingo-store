...
FUNCTION(build_protobuf TARGET_NAME)
    ...
    ExternalProject_Add(
            ...
            # SOURCE_DIR ${PROTOBUF_SOURCES_DIR}/src/${TARGET_NAME}/
            SOURCE_DIR ${CMAKE_SOURCE_DIR}/contrib/protobuf
            CONFIGURE_COMMAND cp -f ${PROTOBUF_SOURCES_DIR}/src/config.sh . COMMAND sh config.sh
            CMAKE_CACHE_ARGS
