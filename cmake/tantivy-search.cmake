...
SET(TANTIVY_SEARCH_INCLUDE_DIR "${TANTIVY_SEARCH_INSTALL_DIR}/include" CACHE PATH "tantivy-search include directory." FORCE)
SET(TANTIVY_SEARCH_LIBRARIES "${TANTIVY_SEARCH_INSTALL_DIR}/lib/libtantivy_search.a" CACHE FILEPATH "tantivy-search library." FORCE)
...
ExternalProject_Add(
    ...
    LIST_SEPARATOR |
    CMAKE_CACHE_ARGS -DCMAKE_INSTALL_PREFIX:PATH=${TANTIVY_SEARCH_INSTALL_DIR}
    -DCMAKE_INSTALL_LIBDIR:PATH=${TANTIVY_SEARCH_INSTALL_DIR}/lib
    -DCMAKE_POSITION_INDEPENDENT_CODE:BOOL=ON
    -DCMAKE_BUILD_TYPE:STRING=${THIRD_PARTY_BUILD_TYPE}
    BUILD_COMMAND $(MAKE)
    INSTALL_COMMAND mkdir -p ${TANTIVY_SEARCH_INSTALL_DIR}/lib/ COMMAND cp ${TANTIVY_SEARCH_BINARY_DIR}/libtantivy_search.a ${TANTIVY_SEARCH_LIBRARIES} COMMAND cp -r ${TANTIVY_SEARCH_SOURCES_DIR}/include ${TANTIVY_SEARCH_INCLUDE_DIR}/
)

ADD_LIBRARY(tantivy-search STATIC IMPORTED GLOBAL)
SET_PROPERTY(TARGET tantivy-search PROPERTY IMPORTED_LOCATION ${TANTIVY_SEARCH_LIBRARIES})
