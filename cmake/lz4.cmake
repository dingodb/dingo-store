...
set(LZ4_INCLUDE_DIR
    ...
    CACHE PATH "lz4 include directory." FORCE)
set(LZ4_LIBRARIES
    "${LZ4_INSTALL_DIR}/lib/liblz4.a"
    CACHE FILEPATH "lz4 library." FORCE)

file(WRITE ${LZ4_BUILD_DIR}/copy_repo.sh "mkdir -p ${LZ4_BUILD_DIR} && cp -rf ${LZ4_SOURCES_DIR}/* ${LZ4_BUILD_DIR}/")
