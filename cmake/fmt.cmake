...
ExternalProject_Add(
  ...
  LIST_SEPARATOR |
  CMAKE_CACHE_ARGS -DCMAKE_INSTALL_PREFIX:PATH=${FMT_INSTALL_DIR} -DCMAKE_INSTALL_LIBDIR:PATH=${FMT_INSTALL_DIR}/lib
                   -DCMAKE_POSITION_INDEPENDENT_CODE:BOOL=ON -DCMAKE_BUILD_TYPE:STRING=${THIRD_PARTY_BUILD_TYPE}
  BUILD_COMMAND $(MAKE)
  INSTALL_COMMAND mkdir -p ${FMT_INSTALL_DIR}/lib/
  COMMAND cp ${FMT_BINARY_DIR}/libfmt${CMAKE_STATIC_LIBRARY_SUFFIX} ${FMT_LIBRARIES}
  COMMAND cp -r ${FMT_SOURCES_DIR}/include ${FMT_INCLUDE_DIR}/)
