...
ExternalProject_Add(
  ...
  COMMAND
    ${LIBUNWIND_SOURCES_DIR}/configure --prefix ${LIBUNWIND_INSTALL_DIR}
    --disable-minidebuginfo --enable-shared --enable-static --with-pic
...
set_property(
  TARGET libunwind
  PROPERTY IMPORTED_LOCATION ${LIBUNWIND_LIBRARIES}
           ${LIBUNWIND_GENERIC_LIBRARIES} ${LIBUNWIND_ARCH_LIBRARIES})
