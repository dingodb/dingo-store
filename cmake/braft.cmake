...
set(BRAFT_INCLUDE_DIR
    "${BRAFT_INSTALL_DIR}/include"
    CACHE PATH "braft include directory." FORCE)
set(BRAFT_LIBRARIES
    "${BRAFT_INSTALL_DIR}/lib/libbraft.a"
    CACHE FILEPATH "braft library." FORCE)

set(prefix_path
    "${THIRD_PARTY_PATH}/install/brpc|${THIRD_PARTY_PATH}/install/gflags|${THIRD_PARTY_PATH}/install/protobuf|${THIRD_PARTY_PATH}/install/zlib|${THIRD_PARTY_PATH}/install/glog|${THIRD_PARTY_PATH}/install/leveldb"
)
...
ExternalProject_Add(
  ...
  COMMAND cp -r ${BRAFT_BINARY_DIR}/output/include ${BRAFT_INCLUDE_DIR}/)
