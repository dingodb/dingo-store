...
set(CONFIGURE_COMMAND_GPERF
    sh autoreconf -i -f COMMAND patch --forward -t --reject-file=- m4/libtool.m4 m4/libtool.patch COMMAND sh autoreconf
    -i COMMAND sh configure --prefix=${GPERFTOOLS_INSTALL_DIR} --enable-shared=no --enable-static=yes --with-pic
    --enable-libunwind --enable-cpu-profiler --enable-heap-profiler --enable-heap-checker
    CPPFLAGS=-I${THIRD_PARTY_PATH}/install/libunwind/include LDFLAGS=-L${THIRD_PARTY_PATH}/install/libunwind/lib
    CXXFLAGS=-g)
