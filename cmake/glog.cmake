...
if(WIN32)
  ...
  set(GLOG_LIBRARIES
      "${GLOG_INSTALL_DIR}/lib/libglog${CMAKE_STATIC_LIBRARY_SUFFIX}"
      CACHE FILEPATH "glog library." FORCE)
...
ExternalProject_Add(
  ...
  CMAKE_CACHE_ARGS -DCMAKE_INSTALL_PREFIX:PATH=${GLOG_INSTALL_DIR} -DCMAKE_INSTALL_LIBDIR:PATH=${GLOG_INSTALL_DIR}/lib
