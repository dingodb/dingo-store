...
message(STATUS "Include snappy...")

set(SNAPPY_SOURCES_DIR ${CMAKE_SOURCE_DIR}/contrib/snappy)
set(SNAPPY_BINARY_DIR ${THIRD_PARTY_PATH}/build/snappy)
...
set(SNAPPY_LIBRARIES
    ...
    CACHE FILEPATH "snappy library." FORCE)
...
ExternalProject_Add(
  ...
  BINARY_DIR ${SNAPPY_BINARY_DIR}
  PREFIX ${SNAPPY_BINARY_DIR}
  UPDATE_COMMAND ""
  ...
  CMAKE_CACHE_ARGS
    -DCMAKE_INSTALL_PREFIX:PATH=${SNAPPY_INSTALL_DIR} -DCMAKE_INSTALL_LIBDIR:PATH=${SNAPPY_INSTALL_DIR}/lib
