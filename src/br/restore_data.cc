  ...
  // init sql data
  {
    if (!restore_sql_data_) {
      ...
      restore_sql_data_ = std::make_shared<RestoreSqlData>(
          ...
          document_region_sql_data_sst_, document_cf_sst_meta_sql_data_sst_, create_region_concurrency_,
  ...
  // init sdk data
  {
    if (!restore_sdk_data_) {
      ...
      restore_sdk_data_ = std::make_shared<RestoreSdkData>(
          ...
          document_region_sdk_data_sst_, document_cf_sst_meta_sdk_data_sst_, create_region_concurrency_,
          restore_region_concurrency_, create_region_timeout_s_, restore_region_timeout_s_, replica_num_);
