...
RestoreSqlData::RestoreSqlData(ServerInteractionPtr coordinator_interaction, ServerInteractionPtr store_interaction,
    ...
    : RestoreDataBase(coordinator_interaction, store_interaction, index_interaction, document_interaction, restorets,
                      restoretso_internal, storage, storage_internal, store_region_sql_data_sst,
                      store_cf_sst_meta_sql_data_sst, index_region_sql_data_sst, index_cf_sst_meta_sql_data_sst,
                      document_region_sql_data_sst, document_cf_sst_meta_sql_data_sst, create_region_concurrency,
                      restore_region_concurrency, create_region_timeout_s, restore_region_timeout_s, replica_num,
                      dingodb::Constant::kSqlData) {}

RestoreSqlData::~RestoreSqlData() = default;

std::shared_ptr<RestoreSqlData> RestoreSqlData::GetSelf() { return shared_from_this(); }

butil::Status RestoreSqlData::Init() { return RestoreDataBase::Init(); }

butil::Status RestoreSqlData::Run() { return RestoreDataBase::Run(); }
