...
#ifndef DINGODB_SIMD_HOOK_H_
#define DINGODB_SIMD_HOOK_H_
...
void fvec_hook(std::string& simd_type);

void fvec_hook_info(std::string& simd_type);

}  // namespace dingodb

#endif  // DINGODB_SIMD_HOOK_H_  // NOLINT
