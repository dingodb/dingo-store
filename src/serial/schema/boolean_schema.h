...
class DingoSchema<bool*> : public BaseSchema
{
    private:
        ...
        void internalEncodeValue(Buf *buf, bool *data);
    ...
    public:
        ...
        bool allowNull();
        void encodeKey(Buf *buf, bool *data);
        bool* decodeKey(Buf *buf);
        void skipKey(Buf *buf);
        void encodeValue(Buf *buf, bool *data);
        bool* decodeValue(Buf *buf);
