...
class DingoSchema<long*> : public BaseSchema
{
    private:
        int index;
        bool key, allow_null;
        ...
        void internalEncodeKey(Buf *buf, long *data);
        void internalEncodeValue(Buf *buf, long *data);
    ...
    public:
        ...
        bool allowNull();
        void encodeKey(Buf *buf, long *data);
        long* decodeKey(Buf *buf);
        void skipKey(Buf *buf);
        void encodeValue(Buf *buf, long *data);
        long* decodeValue(Buf *buf);
