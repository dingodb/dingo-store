...
int DingoSchema<std::optional<std::shared_ptr<std::vector<double>>>>::GetDataLength() { return -1; }

int DingoSchema<std::optional<std::shared_ptr<std::vector<double>>>>::GetWithNullTagLength() { return -1; }
