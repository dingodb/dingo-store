...
class DingoSchema<optional<int32_t>> : public BaseSchema {
 private:
  int index_;
 ...
 public:
  ...
  void EncodeKey(Buf* buf, optional<int32_t> data);
  optional<int32_t> DecodeKey(Buf* buf);
  void SkipKey(Buf* buf);
  void EncodeValue(Buf* buf, optional<int32_t> data);
  optional<int32_t> DecodeValue(Buf* buf);
