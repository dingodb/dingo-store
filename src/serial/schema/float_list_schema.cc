...
int DingoSchema<std::optional<std::shared_ptr<std::vector<float>>>>::GetDataLength() { return -1; }

int DingoSchema<std::optional<std::shared_ptr<std::vector<float>>>>::GetWithNullTagLength() { return -1; }
