...
enum class HandlerType {
  ...
  kPrepareMerge = pb::raft::PREPARE_MERGE,
  kCommitMerge = pb::raft::COMMIT_MERGE,
  kRollbackMerge = pb::raft::ROLLBACK_MERGE,
  ...
  kVectorBatchAdd = pb::raft::VECTOR_BATCH_ADD,

  // document
  kDocumentAdd = pb::raft::DOCUMENT_ADD,
  kDocumentDelete = pb::raft::DOCUMENT_DELETE,
  kDocumentBatchAdd = pb::raft::DOCUMENT_BATCH_ADD,
  ...
  // Document index
  kDocumentIndexLeaderStart = 2100,
  kDocumentIndexLeaderStop = 2101,
  kDocumentIndexFollowerStart = 2102,
  kDocumentIndexFollowerStop = 2103,
};
