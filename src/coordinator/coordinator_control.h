...
class CoordinatorControl : public MetaControl {
 public:
  ...
  static butil::Status ValidateRegionDefinition(const std::string &region_name,
  ...
  void GetStoreOwnMetrics(std::vector<int64_t> store_ids, std::vector<pb::common::StoreOwnMetrics> &store_own_metrics);
