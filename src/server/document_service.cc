...
void DoDocumentBatchQuery(StoragePtr storage, google::protobuf::RpcController* controller,
  ...
  ctx->vector_ids = Helper::PbRepeatedToVector(request->document_ids());
...
void IndexServiceImpl::DocumentBatchQuery(google::protobuf::RpcController* controller,
                                          const pb::document::DocumentBatchQueryRequest* request,
...
static butil::Status ValidateDocumentSearchRequest(StoragePtr storage,
  ...
  if (request->parameter().top_n() * request->vector_with_ids_size() > FLAGS_document_max_batch_count * 10) {
    return butil::Status(
        pb::error::EVECTOR_EXCEED_MAX_BATCH_COUNT,
        fmt::format("Param top_n {} * vector_with_ids_size {} is exceed max batch count {} * 10",
                    request->parameter().top_n(), request->vector_with_ids_size(), FLAGS_document_max_batch_count));
  }
...
void DoDocumentSearch(StoragePtr storage, google::protobuf::RpcController* controller,
  ...
  std::vector<pb::document::DocumentWithScoreResult> vector_results;
  status = storage->DocumentBatchSearch(ctx, vector_results);
  if (!status.ok()) {
    ServiceHelper::SetError(response->mutable_error(), status.error_code(), status.error_str());
    return;
  }
...
void IndexServiceImpl::DocumentSearch(google::protobuf::RpcController* controller,
                                      const pb::document::VectorSearchRequest* request,
                                      pb::document::VectorSearchResponse* response, google::protobuf::Closure* done) {
  auto* svr_done = new ServiceClosure(__func__, done, request, response);
...
static butil::Status ValidateDocumentAddRequest(StoragePtr storage, const pb::document::DocumentAddRequest* request,
  ...
  if (request->documents().empty()) {
    return butil::Status(pb::error::EVECTOR_EMPTY, "Document quantity is empty");
  }

  if (request->vectors_size() > FLAGS_document_max_batch_count) {
    return butil::Status(pb::error::EVECTOR_EXCEED_MAX_BATCH_COUNT,
...
void DoDocumentAdd(StoragePtr storage, google::protobuf::RpcController* controller,
  ...
  std::vector<pb::common::DocumentWithId> vectors;
  for (const auto& vector : request->vectors()) {
    vectors.push_back(vector);
  }

  status = storage->DocumentAdd(ctx, is_sync, vectors, request->is_update());
  if (!status.ok()) {
    ServiceHelper::SetError(response->mutable_error(), status.error_code(), status.error_str());
...
void IndexServiceImpl::DocumentAdd(google::protobuf::RpcController* controller,
...
static butil::Status ValidateDocumentDeleteRequest(StoragePtr storage,
  ...
  if (request->ids().empty()) {
    return butil::Status(pb::error::EVECTOR_EMPTY, "Document id quantity is empty");
  }
...
void IndexServiceImpl::DocumentDelete(google::protobuf::RpcController* controller,
                                      const pb::document::DocumentDeleteRequest* request,
                                      pb::document::DocumentDeleteResponse* response, google::protobuf::Closure* done) {
  auto* svr_done = new ServiceClosure(__func__, done, request, response);
...
void IndexServiceImpl::DocumentGetBorderId(google::protobuf::RpcController* controller,
                                           const pb::document::DocumentGetBorderIdRequest* request,
...
void DoDocumentScanQuery(StoragePtr storage, google::protobuf::RpcController* controller,
  ...
  std::vector<pb::common::DocumentWithId> vector_with_ids;
  status = storage->DocumentScanQuery(ctx, vector_with_ids);
  if (!status.ok()) {
    ServiceHelper::SetError(response->mutable_error(), status.error_code(), status.error_str());
...
void IndexServiceImpl::DocumentScanQuery(google::protobuf::RpcController* controller,
                                         const pb::document::DocumentScanQueryRequest* request,
...
void IndexServiceImpl::DocumentGetRegionMetrics(google::protobuf::RpcController* controller,
                                                const pb::document::DocumentGetRegionMetricsRequest* request,
...
void DoDocumentCount(StoragePtr storage, google::protobuf::RpcController* controller,
  ...
  int64_t count = 0;
  status = storage->DocumentCount(region, GenCountRange(region, request->vector_id_start(), request->vector_id_end()),
                                  count);
  if (!status.ok()) {
    ServiceHelper::SetError(response->mutable_error(), status.error_code(), status.error_str());
...
void IndexServiceImpl::DocumentCount(google::protobuf::RpcController* controller,
                                     const pb::document::DocumentCountRequest* request,
                                     pb::document::DocumentCountResponse* response, ::google::protobuf::Closure* done) {
  auto* svr_done = new ServiceClosure(__func__, done, request, response);
...
void DoTxnGetDocument(StoragePtr storage, google::protobuf::RpcController* controller,
  ...
  if (!kvs.empty()) {
    for (auto& kv : kvs) {
      pb::common::DocumentWithId vector_with_id;
...
void IndexServiceImpl::Hello(google::protobuf::RpcController* controller, const pb::document::HelloRequest* request,
...
void IndexServiceImpl::GetMemoryInfo(google::protobuf::RpcController* controller,
                                     const pb::document::HelloRequest* request, pb::document::HelloResponse* response,
                                     google::protobuf::Closure* done) {
  // Run in queue.
  auto* svr_done = new ServiceClosure(__func__, done, request, response);
