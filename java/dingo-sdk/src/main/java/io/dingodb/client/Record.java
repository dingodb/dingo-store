...
public final class Record {
     ...
     */
    public Record(final List<io.dingodb.sdk.common.table.Column> columnDefinitions, final Column[] inputColumns) {
    ...
    public Record(final String keyColumn, final Map<String, Object> columns) {
        this(Collections.singletonList(keyColumn), columns);
    }
    ...
    public Record(final List<String> keyColumns, final Map<String, Object> columns) {
        ...
        if (!isValid) {
            ...
            throw new RuntimeException("Key columns are not in the record.");
        }
