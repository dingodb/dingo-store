...
public class MetaServiceClient {
    ...
    private final Map<Meta.DingoCommonId, Table> tableDefinitionCache = new ConcurrentSkipListMap<>();
    ...
    public boolean createTable(@NonNull String tableName, @NonNull Table table) {
        Meta.TableDefinition definition = EntityConversion.swap(table);
    ...
    public boolean dropTable(@NonNull String tableName) {
        Meta.DropTableRequest request = Meta.DropTableRequest.newBuilder()
                .setTableId(tableIdCache.get(tableName))
                .build();
